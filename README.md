...
The arrow keys or remote control directional mutes and unmutes windows based on which direction is clicked.   It uses three consecutive left clicks to close application.<br> It uses three consecutive right clicks to mute.<br>
...
On non termux or Standard Linux change the directory of location of file with urls.<br>
...
Adjust adaptive resolution in code appropriately to what your computer can handle.<br>
