...
The arrow keys or remote control directional mutes and unmutes windows based on which direction is clicked.   It uses three consecutive left clicks to close application.<br>
...
Adjust addaptive resolution in code appropriately to power your computer can handle.<b>
